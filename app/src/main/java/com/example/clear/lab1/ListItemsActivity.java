...
public class ListItemsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageButton = (ImageButton) findViewById(R.id.imageButton); // reference
        Switch switch1 = (Switch) findViewById(R.id.switch1); // reference
        CheckBox checkBox = (CheckBox) findViewById(R.id.checkBox); // reference
